          ...
          {siteConfig.capabilities.map((cap, i) => {
            ...
            return (
              <Reveal key={cap.id} delay={i * 0.06}>
                <Float strength={0.9 + (i % 4) * 0.2}>
                <Interactive
                  as="div"
                  className="group relative h-full overflow-hidden rounded-2xl glass glass-spotlight p-6 transition-colors duration-500"
                >
                  {/* Spotlight glow handled by CSS */}
