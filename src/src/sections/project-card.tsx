...
export function ProjectCard({ project, onOpen }: Props) {
  ...
  return (
    <motion.div
      ...
      className="group relative flex cursor-pointer flex-col overflow-hidden rounded-2xl glass glass-spotlight p-6 transition-[transform,shadow] duration-300 hover:shadow-[0_24px_60px_-24px_rgba(0,229,255,0.15)] sm:p-8"
      style={{ transition: "transform 0.3s cubic-bezier(0.16,1,0.3,1)", transformStyle: "preserve-3d" }}
    >
      {/* Spotlight overlay handled by CSS ::before and ::after pseudo-elements */}
