      ...
      <div className="mt-16 grid grid-cols-1 gap-12 lg:grid-cols-12">
        ...
        <Reveal delay={0.15} className="lg:col-span-7">
          ...
          <form
            ...
            noValidate
            className="glass glass-spotlight rounded-3xl p-6 md:p-8"
          >
...
function ContactLink({
  ...
  return (
    <a
      ...
      data-cursor="true"
      className="group flex items-center justify-between rounded-2xl glass glass-spotlight px-5 py-4 transition-colors duration-300"
    >
...
function Field({
  ...
  const base =
    "w-full rounded-xl border bg-bg/60 px-4 py-3 text-sm text-fg placeholder:text-fg-subtle/70 outline-none transition-colors duration-300 focus:border-gold/60"
