...
export function Section({ id, children, className, full }: SectionProps) {
  return (
    <section
      id={id}
      className={cn(
        "relative mx-auto w-full max-w-6xl px-5 sm:px-8",
    ...
    <Reveal className={cn("mb-4", className)}>
      ...
      <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <h2 className="mt-4 max-w-2xl text-balance font-display text-3xl font-semibold tracking-tight text-spotlight md:text-4xl lg:text-5xl">
            {title}
          </h2>
          {subtitle && (
